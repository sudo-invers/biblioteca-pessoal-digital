...
class Publication(ABC):
    ...
    def __init__(self, id: int, title: string, author: string, year: int, inclusionDate: Date, pagesNumber: int, avaliation: int, genre: string, anotations: Anotation, status: ReadingStatus, type: PublicationType):
        self._id = id
        self._title = title
        self._author =author
        self._year = year
